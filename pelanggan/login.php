          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form action="proses_login.php" method="post">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Login Menggunakan Akunmu!</h5>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Belum Punya Akun? <a href="daftar.php" type="button" ><h4>daftar</h4></a></p>
